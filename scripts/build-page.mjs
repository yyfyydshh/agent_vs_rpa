...
<body>
  ...
  <script>
    ...
    function renderSection(sec) {
      ...
      articleBody.innerHTML = '<section id="' + sec.id + '" data-title="' + escapeHtml(sec.title) + '"><h2>' + inline(sec.title) + '</h2>' + visualHtml + parseBlocks(lines).join("") + '<div class="section-actions"><button class="mini" id="prevSection" type="button">上一章</button><button class="mini" id="nextSection" type="button">下一章</button></div></section>';
